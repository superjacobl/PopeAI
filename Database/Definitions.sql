...
CREATE TABLE IF NOT EXISTS bottimes (
    ...
    lastplanetstatupdate timestamp with time zone NOT NULL,
...
CREATE TABLE IF NOT EXISTS currentstats (
    ...
    dailynewcoins integer NOT NULL,
    dailymessagessent integer NOT NULL,
    dailymessagesuserssent integer NOT NULL,
    hourlynewcoins integer NOT NULL,
    hourlymessagessent integer NOT NULL,
    hourlymessagesuserssent integer NOT NULL,
